<template>
  <el-container id="card">
    <el-header>
      ...
      <el-select v-model="listQuery.unit" placeholder="统计间隔" clearable style="width: 150px" class="filter-item">
      ...
      <el-date-picker v-model="listQuery.startTime" size="mini" style="width: 50%;margin-top:10px;" value-format="yyyy-MM-dd HH:mm:ss" type="datetime" placeholder="起始日期" default-time="00:00:00" />
      <el-date-picker v-model="listQuery.endTime" size="mini" style="width: 40%;margin-top:10px;" value-format="yyyy-MM-dd HH:mm:ss" type="datetime" placeholder="结束日期" default-time="23:59:59" />

    </el-header>
    <el-main>
      <div id="line-api" style="height: 540px;width: 100%" />
    </el-main>
...
// import { fetchApiTimeList } from '@/api/count'
...
export default {
  ...
  data() {
    return {
      ...
      timeUnits: ['DAY', 'MINUTE', 'HOUR', 'MOINTH']
    }
  },
  mounted() {
    this.initChart()
  ...
  methods: {
    initChart() {
      this.chart = echarts.init(document.getElementById('line-api'), 'macarons')
